...
<div class ="row">
			...
			<div class="mb-14">
  					<div align='left'><label class="form-label"> ID Motor</label>
  					<input type="text" name="id" class="form-control"  placeholder="Masukan ID Motor">
				</div>

				<div class="mb-14">
  					<div align='left'><label class="form-label"> Nama Motor</label>
  					<input type="text" name="nama" class="form-control"  placeholder="Masukan Nama Motor">
				</div>

				<div class="mb-14">
  					<div align='left'><label class="form-label"> Jenis Motor</label>
  					<input type="text" name="jenis" class="form-control" placeholder="Masukan Jenis Motor">
				</div>
...
<a href="motor.php" class="btn btn-info">
	...
	if(isset($_POST['Submit'])) {
		...
		$result = mysqli_query($conn, "INSERT INTO data_motor(id,nama,jenis,no_rangka,no_mesin,tgl_produksi,pabrikan) VALUES('$id','$nama','$jenis','$no_rangka','$no_mesin','$tgl_produksi','$pabrikan')");
		
		// Show message when user added
		echo "Data Berhasil Di simpan. <a href='motor.php 'class='btn btn-success'>Liat Data</a>";
	}
	?>
</body>
</html>