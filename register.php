...
<link rel="icon" 
    ...
    <title>Auto Mobile - Daftar</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p></p>
                                        <center><marquee><h5> <span style="color :#808080;"> Silakan Masukan NPM Nama lengkap Dan Password^-^ </span> </h5></marquee>
                                    </div>
                                    <form class="user" method="post" action="proses_register.php">
                                        <div class="form-group">
                                            <input name="npm" required type="number" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Masukan NPM.....">
                                        </div>
                                        <div class="form-group">
                                            <input name="nama" required type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
