                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang Di Aplikasi Auto Mobile Saya!</h1>
                                        <img width=280 height=260 src='images/images.PNG' />
                                        <p></p>
                                        <center><marquee><h5> <span style="color :#808080;"> Silakan Masukan NPM Dan Password Anda^-^ </span> </h5></marquee>
                                    </div>
